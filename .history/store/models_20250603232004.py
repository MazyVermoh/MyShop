...
class Order(models.Model):
    ...
    def total_price(self) -> Decimal:
        """
        Для совместимости: возвращает то же, что total().
        Используется в платежном API, где ожидалось поле total_price.
        """
        return self.total()
...
class Subscriber(models.Model):
    ...
    confirmed = models.BooleanField(default=True)   # на будущее для double opt-in
